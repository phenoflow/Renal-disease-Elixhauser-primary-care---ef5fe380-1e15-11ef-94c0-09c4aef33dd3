...
(async () => {
  ...
  await fs.writeFile("renal-disease-elixhauser-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("renal-disease-elixhauser-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
